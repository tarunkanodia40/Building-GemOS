...
int main(u64 arg1, u64 arg2, u64 arg3, u64 arg4, u64 arg5)
{
  ...
  if (cpid < 0) {
   ...
   ret = wait_and_continue();
	...
	//goto third fn_1 - inner most top
    ret = wait_and_continue();
	//coming from inner most end
    ret = wait_and_continue();
	//comming from middle end
    ret = wait_and_continue();
  	//comming from upper end
    ret = wait_and_continue();

 printf("In Parent main(). parent about to exit.\n");
  }
