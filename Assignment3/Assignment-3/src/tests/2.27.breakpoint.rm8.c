...
int main(u64 arg1, u64 arg2, u64 arg3, u64 arg4, u64 arg5)
{
  ...
  printf("fn_1 address: %x \n", fn_1);
    ...
    printf("In Parent main(). Child in fn_1() beginning. 1st\n");
    ...
    printf("In Parent main(). Child in fn_1() beginning. 2nd\n");

    ret = remove_breakpoint(fn_1);
    printf("Remove Breakpoint on fn_1 returned %d\n", (int)ret);
    ...
    printf("In Parent main(). Child in fn_1() beginning. 3rd\n");
    ...
    printf("In Parent main(). Child in fn_1() end. 3rd\n");
    ...
    printf("In Parent main(). Child in fn_1() end. 2nd\n");
    ...
    printf("In Parent main(). Child in fn_1() end. 1st\n");
